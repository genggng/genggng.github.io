...
- *2026.08*: A first-author preprint (ScaleQ-1.58) on cost-efficient 1.58-bit post-training quantization of reasoning LLMs is released on **arXiv**.
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">arXiv 2026</div><img src='images/scaleq.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
**Shigeng Wang\***, Chao Li\*, Yangyuxuan Kang, Jiawei Fan, Anbang Yao#. arXiv preprint, 2026.

<p><a href="https://github.com/IntelChina-AI/BitTern"><strong>Code</strong></a> | <a href="https://github.com/IntelChina-AI/BitTern"><strong>Project</strong></a></p>

ScaleQ-1.58 is a scalable ternary post-training quantization (PTQ) framework for reasoning LLMs. Its core insight is the Attend to Your Own Thoughts (AYOT) calibration strategy: using reasoning traces and final answers self-generated by the pre-trained LLM as calibration context. With only 4M calibration tokens (1,000,000× fewer than BitNet-style training), it enables ternary Qwen3-1.7B to reach over 90.52% of the prior-best BitNet b1.58 2B4T performance, and scales to 235B parameters across dense and MoE architectures.
